...
export default function ServiceDetail() {
  return (
    <>
      ...
      <section style={{ padding: 'clamp(64px, 8vw, 120px) var(--gutter)', background: '#0E0F20' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '64px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: '800', color: '#000000', letterSpacing: '-0.02em', lineHeight: '1.1' }}>
              High-Precision <br />
      ...
      {/* Tech Stack used */}
      <section style={{ padding: '80px var(--gutter)', background: '#0E0F20', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h3 style={{ fontSize: '28px', fontWeight: '800', color: '#000000', margin: '12px 0 32px 0', letterSpacing: '-0.01em' }}>Software & Tools We Employ</h3>
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '16px' }}>
            
            <div style={{ padding: '14px 28px', background: '#FFFFFF', border: '1px solid #000000', borderRadius: '6px', fontSize: '13px', fontWeight: '700', color: '#000000', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
              Dlubal RFEM
            </div>
            <div style={{ padding: '14px 28px', background: '#FFFFFF', border: '1px solid #000000', borderRadius: '6px', fontSize: '13px', fontWeight: '700', color: '#000000', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
              RISA-3D
