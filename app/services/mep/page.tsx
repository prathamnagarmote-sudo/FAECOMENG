          ...
          subtitle={
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <h2 style={{ fontSize: 'clamp(24px, 3vw, 32px)', fontWeight: '900', color: '#FF6B2C', margin: '8px 0 0 0', lineHeight: 1.2 }}>
                About Our MEP Engineering Solutions Expertise
              </h2>
              <span style={{ color: '#FF6B2C', fontWeight: 'bold' }}>
                Mechanical, Electrical, and Plumbing engineering designed for safety, efficiency, and long-term performance.
              </span>
              <p style={{ color: '#000000', fontSize: '16.5px', lineHeight: 1.6, margin: 0, fontWeight: 'bold', fontFamily: 'var(--font-body)' }}>
                FAECOM specializes in Mechanical, Electrical, and Plumbing (MEP) engineering solutions designed to optimize efficiency, safety, and sustainability in construction. Our cost-effective and high-performance designs cater to a wide range of industries, ensuring compliance with global standards and seamless project execution.
              </p>
            </div>
          }
