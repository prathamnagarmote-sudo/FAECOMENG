  ...
  return (
    <>
      <motion.div
        ...
        className={styles.rebarHeroWrapper}
      >
        <PageHero
          ...
          subtitle={
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <h2 style={{ fontSize: 'clamp(24px, 3vw, 32px)', fontWeight: '900', color: '#FF6B2C', margin: '8px 0 0 0', lineHeight: 1.2 }}>
                About Our Rebar Detailing & Concrete Solutions Expertise
              </h2>
              <span style={{ color: '#FF6B2C', fontWeight: 'bold' }}>
                Precise placing drawings, bar lists, and concrete reinforcement detailing.
              </span>
              <p style={{ color: '#000000', fontSize: '16.5px', lineHeight: 1.6, margin: 0, fontWeight: 'bold', fontFamily: 'var(--font-body)' }}>
                At Faecom Engineering, we specialize exclusively in the Design and Detailing of concrete structures, delivering precise, reliable, and code-compliant solutions to support your construction projects.
              </p>
              <p style={{ color: '#000000', fontSize: '16.5px', lineHeight: 1.6, margin: 0, fontWeight: 'bold', fontFamily: 'var(--font-body)' }}>
