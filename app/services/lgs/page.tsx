  ...
  return (
    <>
      ...
      <PageHero
        ...
        title="Light"
        titleEm="Gauge Steel (LGS) Solutions"
        subtitle="Cold-formed steel engineering for rapid, high-strength, and sustainable building systems."
      />
        ...
        <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto', display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '64px', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: '800', color: '#0F1238', letterSpacing: '-0.02em', lineHeight: '1.1' }}>
              High-Precision <br />
              <span style={{ color: 'var(--accent)' }}>Light Gauge Steel (LGS) Solutions</span>
            </h2>

            <p style={{ fontSize: '15px', color: '#4A4D6B', lineHeight: '1.7' }}>
              Light Gauge Steel (LGS) framing is the future of lightweight, structural design. Our team delivers precise engineering calculations, load-bearing analysis, and production-ready shop drawings for modular, residential, and commercial developments.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '16px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
                ...
                <span style={{ fontSize: '13.5px', color: '#1E224E', fontWeight: '500', lineHeight: '1.5' }}>
                  Load-bearing wall and floor joist designs conforming to AISI S100 standards.
                </span>
              </div>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
                <div style={{ marginTop: '4px', width: '6px', height: '6px', borderRadius: '50%', background: 'var(--accent)', flexShrink: 0 }} />
                <span style={{ fontSize: '13.5px', color: '#1E224E', fontWeight: '500', lineHeight: '1.5' }}>
                  Fully detailed shop drawings with precise member lengths, screw locations, and assembly instructions.
                </span>
              </div>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
                <div style={{ marginTop: '4px', width: '6px', height: '6px', borderRadius: '50%', background: 'var(--accent)', flexShrink: 0 }} />
                <span style={{ fontSize: '13.5px', color: '#1E224E', fontWeight: '500', lineHeight: '1.5' }}>
                  Integration with CNC roll-forming machines for direct factory production (LGSF).
                </span>
              </div>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
                <div style={{ marginTop: '4px', width: '6px', height: '6px', borderRadius: '50%', background: 'var(--accent)', flexShrink: 0 }} />
                <span style={{ fontSize: '13.5px', color: '#1E224E', fontWeight: '500', lineHeight: '1.5' }}>
                  PE-stamped engineering calculations for code compliance across North America.
                </span>
              </div>
            </div>
          ...
          <div style={{ position: 'relative', width: '100%', height: '560px', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 20px 48px rgba(0,0,0,0.08)' }}>
            <Image
              ...
              alt="Light Gauge Steel (LGS) Solutions"
              fill
