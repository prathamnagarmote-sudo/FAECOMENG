    ...
    <footer className={styles.footer} role="contentinfo">
      ...
      <div className={styles.main}>
        ...
        <div>
          ...
          {/* Social Icons (LinkedIn, Instagram, YouTube, Facebook, X) */}
          <div className={styles.social}>
            ...
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="FAECOM on YouTube" className={styles.socialBtn}>
            ...
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="FAECOM on Facebook" className={styles.socialBtn}>
